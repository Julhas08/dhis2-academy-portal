	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			if ( ! in_array( $hook, array( 'post-new.php', 'post.php', 'media-upload-popup' ) ) )
				...
				add_thickbox();
				wp_enqueue_script('multi-post-thumbnails-admins', jbrsoft_url . '/assets/js/multi-post-thumbnails-admin.js', array('jquery'), '1.0', false); 
        		wp_enqueue_script('multi-post-thumbnails-admins');
			 	
 				wp_register_style( 'multi-post', jbrsoft_url . '/assets/css/multi-post-thumbnails-admin.css', array(), '1.0', 'all' );
        
        		wp_enqueue_style('multi-post'); 
			 }
